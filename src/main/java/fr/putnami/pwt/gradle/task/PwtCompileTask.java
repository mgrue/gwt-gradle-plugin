...
public class PwtCompileTask extends AbstractPwtTask {

	public static final String NAME = "pwtCompile";

	public PwtCompileTask() {
		setName(NAME);
	...
	public void exec() {
		...
		File genDir = ResourceUtils.ensureDir(buildDir, "pwt/gen");
		File warConfDir = ResourceUtils.ensureDir(buildDir, "pwt/war");
		File deployDir = ResourceUtils.ensureDir(buildDir, "pwt/deploy");
		File extraConfDir = ResourceUtils.ensureDir(buildDir, "pwt/extra");
		...
		// builder.addArgs("-logLevel ");
		builder.addArgs("-workDir " + workDir.getAbsolutePath());
		// builder.addArgs("-[no]compileReport ");
		// builder.addArgs("-[no]draftCompile ");
		builder.addArgs("-gen " + genDir.getAbsolutePath());
		// builder.addArgs("-XjsInteropMode ");
		// builder.addArgs("-optimize ");
		// builder.addArgs("-style ");
		// builder.addArgs("-localWorkers ");
		// builder.addArgs("-incremental ");
		builder.addArgs("-war " + warConfDir.getAbsolutePath());
		builder.addArgs("-deploy " + deployDir.getAbsolutePath());
		builder.addArgs("-extra " + extraConfDir.getAbsolutePath());

		builder.addArgs("fr.pwt.testplugin.Test");
